...
class PyApp(gtk.Window):
   def __init__(self):
      ...
      self.btn.connect("button_press_event", self.hello, combobox, combobox1, lbl3, lbl4, lblCounter)
   ...
   def hello(self,widget,event,combobox,combobox1,lbl3,lbl4,lblCounter):

      time_now = datetime.datetime.now().time()
      date_now = datetime.datetime.now().date()
      time_finish = self.addSecs(time_now, (int(combobox.get_active_text())*60))
